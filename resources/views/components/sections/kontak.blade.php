 ...
 <section class="w-full bg-slate-100 py-20">
   <div class="max-w-screen-lg mx-auto grid gap-2 px-2">
     ...
     {{-- <div class="grid grid-cols-3 gap-2">
       <div class="flex items-center bg-white border border-slate-300 gap-2 p-2 rounded-xl">
       ...
       <div class="flex items-center bg-slate-50 hover:bg-white gap-2 p-2 rounded-xl">
     ...
     <div class="border border-slate-200 bg-white w-full h-auto md:h-96 rounded-xl flex flex-col md:flex-row">
