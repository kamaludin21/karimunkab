    ...
    <div class="max-w-screen-lg px-2 bg-white mx-auto grid gap-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div
          ...
          <div class="bg-slate-800/50 p-4 h-full flex flex-col gap-2 w-full justify-between">
            <div>
        ...
        <div class="h-full w-full grid grid-cols-2 gap-2 md:gap-4 auto-rows-fr">
          ...
          <div
            ...
            <div class="bg-slate-800/50 p-4 h-full flex gap-2 flex-col w-full justify-between">
              <div>
                <div class="w-fit p-0.5 rounded-md text-slate-100 text-sm">
                  <p>12 Januari 2025 | Politik</p>
                </div>
