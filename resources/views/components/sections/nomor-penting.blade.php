  <section class="w-full bg-white py-10 md:py-20">
    <div class="max-w-screen-lg dot-pattern mx-auto grid gap-6 rounded-xl pt-16 pb-2 md:pb-4 px-2 md:px-4">
      ...
      <div
        class="flex items-center gap-4 before:h-px before:flex-1 before:bg-slate-700  before:content-[''] after:h-px after:flex-1 after:bg-slate-700  after:content-['']">
        <button
          ...
          <svg viewBox="0 0 24 24"  fill="none"  stroke="currentColor" stroke-linecap="round"  stroke-linejoin="round"  class="h-5 w-5 stroke-[1.7]"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M5 4h4l2 5l-2.5 1.5a11 11 0 0 0 5 5l1.5 -2.5l5 2v4a2 2 0 0 1 -2 2a16 16 0 0 1 -15 -15a2 2 0 0 1 2 -2" /></svg>
        </button>
      </div>
      ...
      <div class="grid grid-cols-2 md:grid-cols-3 gap-2 md:gap-4 mt-4 md:mt-8">
        ...
        <div class="p-2 md:p-4 rounded-lg bg-white space-y-1">
          ...
          <div class="flex flex-col md:flex-row gap-2 mt-4 font-medium">
            <button
              class="text-center text-slate-700 gap-1 border-1 border-slate-400 py-1 md:py-2 px-2 flex-1 rounded-lg active:scale-95">
              Telepon
            </button>
        ...
        <div class="p-2 md:p-4 rounded-lg bg-white space-y-1">
          <p class="text-lg font-medium text-slate-800 leading-5">UPT PKM TG BALAI</p>
          <p class="text-base font-light text-slate-600 leading-5">Sudirman</p>
          <div class="flex flex-col md:flex-row gap-2 mt-4 font-medium">
            <button
              class="text-center text-slate-700 gap-1 border-1 border-slate-400 py-1 md:py-2 px-2 flex-1 rounded-lg active:scale-95">
              Telepon
        ...
        <div class="p-2 md:p-4 rounded-lg bg-white space-y-1">
          <p class="text-lg font-medium text-slate-800 leading-5">UPT PKM KUBA</p>
          <p class="text-base font-light text-slate-600 leading-5">Ruzali</p>
          <div class="flex flex-col md:flex-row gap-2 mt-4 font-medium">
            <button
              class="text-center text-slate-700   gap-1 border-1 border-slate-400 py-1 md:py-2 px-2 flex-1 rounded-lg active:scale-95">
              Telepon
