    ...
    <section class="flex gap-8 items-center py-16">
      <div class="flex-1 w-1/2">
        <img
          ...
          class="w-full h-auto cover rounded-lg ring-1 ring-zinc-300 shadow-md hover:shadow-lg" alt="">
      </div>
      <div class="flex-1 grid gap-4 place-content-center justify-start">
        ...
        <h1 class="font-medium text-5xl leading-[1.1] text-slate-600 line-clamp-3">
          ...
          <a href="/berita/slug"
            ...
            ring-2 ring-slate-600 p-2 rounded-full group
            hover:bg-black transition duration-200 ml-2">
      ...
      <div class="max-w-screen-lg grid gap-8 mx-auto w-full">
        ...
        <div class="flex justify-between">
          <div class="flex gap-4 items-center text-slate-500 font-medium">
            <div class="py-1 px-3 bg-white border border-slate-200 rounded-full text-orange-600">Semua Berita</div>
