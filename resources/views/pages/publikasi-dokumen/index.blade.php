@php
  ...
  $documents = \App\Models\Document::with('institute')->orderBy('published_at', 'desc')->paginate(10);
@endphp

@extends('layouts.app', ['activePage' => 'informasi-publik'])

@section('content')
  <section class="max-w-screen-lg mx-auto w-full py-0 lg:py-6 space-y-6 min-h-96 mb-16">
